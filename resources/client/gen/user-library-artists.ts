...
export const userLibraryArtistsIndex = (
  user: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/users/${user}/liked-artists`, method: 'GET'},
    options,
  );
};
export type UserLibraryArtistsIndexResult = NonNullable<
  Awaited<ReturnType<typeof userLibraryArtistsIndex>>
>;
