...
export const trackFileMetadataExtract = (
  fileEntry: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/tracks/${fileEntry}/extract-metadata`, method: 'POST'},
    options,
  );
};
export type TrackFileMetadataExtractResult = NonNullable<
  Awaited<ReturnType<typeof trackFileMetadataExtract>>
>;
