...
export const importMediaImport = (
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/import-media/single-item`, method: 'POST'},
    options,
  );
};
export type ImportMediaImportResult = NonNullable<
  Awaited<ReturnType<typeof importMediaImport>>
>;
