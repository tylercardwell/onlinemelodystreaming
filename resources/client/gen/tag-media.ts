...
export const tagMediaTracks = (
  tagName: string,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/tags/${tagName}/tracks`, method: 'GET'},
    options,
  );
};
export const tagMediaAlbums = (
  tagName: string,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/tags/${tagName}/albums`, method: 'GET'},
    options,
  );
};
export type TagMediaTracksResult = NonNullable<
  Awaited<ReturnType<typeof tagMediaTracks>>
>;
export type TagMediaAlbumsResult = NonNullable<
  Awaited<ReturnType<typeof tagMediaAlbums>>
>;
