...
export const userLibraryAlbumsIndex = (
  user: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/users/${user}/liked-albums`, method: 'GET'},
    options,
  );
};
export type UserLibraryAlbumsIndexResult = NonNullable<
  Awaited<ReturnType<typeof userLibraryAlbumsIndex>>
>;
