...
export const repostIndex = (
  user: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/users/${user}/reposts`, method: 'GET'},
    options,
  );
};
export const repostToggle = (
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/reposts/toggle`, method: 'POST'},
    options,
  );
};
export type RepostIndexResult = NonNullable<
  Awaited<ReturnType<typeof repostIndex>>
>;
export type RepostToggleResult = NonNullable<
  Awaited<ReturnType<typeof repostToggle>>
>;
