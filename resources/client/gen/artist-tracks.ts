...
export const artistTracksIndex = (
  artist: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/artists/${artist}/tracks`, method: 'GET'},
    options,
  );
};
export type ArtistTracksIndexResult = NonNullable<
  Awaited<ReturnType<typeof artistTracksIndex>>
>;
