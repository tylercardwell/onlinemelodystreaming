...
export const channelContentOrderChangeOrder = (
  channelId: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/channel/${channelId}/reorder-content`, method: 'POST'},
    options,
  );
};
export type ChannelContentOrderChangeOrderResult = NonNullable<
  Awaited<ReturnType<typeof channelContentOrderChangeOrder>>
>;
