 ...
 */
import type {RetrieveNormalizedModel200Data} from './retrieve-normalized-model200-data';

export type RetrieveNormalizedModel200 = {
  data: RetrieveNormalizedModel200Data;
};
