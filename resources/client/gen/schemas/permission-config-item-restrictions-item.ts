 ...
 */
import type {PermissionConfigItemRestrictionsItemType} from './permission-config-item-restrictions-item-type';

export type PermissionConfigItemRestrictionsItem = {
  name: string;
  display_name: string;
  type: PermissionConfigItemRestrictionsItemType;
  description: string;
};
