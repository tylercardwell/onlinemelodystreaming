 ...
 */
import type {BackstageRequestShow200Request} from './backstage-request-show200-request';

export type BackstageRequestShow200 = {
  request: BackstageRequestShow200Request;
};
