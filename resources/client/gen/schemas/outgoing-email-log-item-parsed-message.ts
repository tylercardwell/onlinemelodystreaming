 ...
 */
import type {OutgoingEmailLogItemParsedMessageBody} from './outgoing-email-log-item-parsed-message-body';

export type OutgoingEmailLogItemParsedMessage = {
  headers: string[];
  body: OutgoingEmailLogItemParsedMessageBody;
};
