 ...
 */
import type {UpdateNotificationSubscriptionsBodySelectionsItem} from './update-notification-subscriptions-body-selections-item';

export type UpdateNotificationSubscriptionsBody = {
  selections: UpdateNotificationSubscriptionsBodySelectionsItem[];
};
