 ...
 * @nullable
 */
export type NotificationDataButtonActionsItemColor =
  | (typeof NotificationDataButtonActionsItemColor)[keyof typeof NotificationDataButtonActionsItemColor]
  | null;

export const NotificationDataButtonActionsItemColor = {
  primary: 'primary',
  secondary: 'secondary',
  danger: 'danger',
  positive: 'positive',
