 ...
 * @nullable
 */
export type NotificationDataLinesItemActionColor =
  | (typeof NotificationDataLinesItemActionColor)[keyof typeof NotificationDataLinesItemActionColor]
  | null;

export const NotificationDataLinesItemActionColor = {
  primary: 'primary',
  secondary: 'secondary',
  danger: 'danger',
  positive: 'positive',
