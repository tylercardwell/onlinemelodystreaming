...
export type CreateS3MultipartUpload200Acl =
  (typeof CreateS3MultipartUpload200Acl)[keyof typeof CreateS3MultipartUpload200Acl];

export const CreateS3MultipartUpload200Acl = {
