 ...
 */
import type {UpdateRoleBodyPermissionsItemRestrictionsItem} from './update-role-body-permissions-item-restrictions-item';

export type UpdateRoleBodyPermissionsItem = {
  id?: number;
  restrictions?: UpdateRoleBodyPermissionsItemRestrictionsItem[];
};
