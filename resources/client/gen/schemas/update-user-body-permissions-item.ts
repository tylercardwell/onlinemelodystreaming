 ...
 */
import type {UpdateUserBodyPermissionsItemRestrictionsItem} from './update-user-body-permissions-item-restrictions-item';

export type UpdateUserBodyPermissionsItem = {
  id?: number;
  restrictions?: UpdateUserBodyPermissionsItemRestrictionsItem[];
};
