 ...
 */
import type {NotificationDataMainActionColor} from './notification-data-main-action-color';

export type NotificationDataMainAction = {
  label: string;
  action: string;
  emitOnly?: boolean;
  /** @nullable */
  color?: NotificationDataMainActionColor;
};
