 ...
 */
import type {NotificationDataButtonActionsItemColor} from './notification-data-button-actions-item-color';

export type NotificationDataButtonActionsItem = {
  label: string;
  action: string;
  emitOnly?: boolean;
  /** @nullable */
  color?: NotificationDataButtonActionsItemColor;
};
