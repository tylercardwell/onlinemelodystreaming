...
export type NotificationDataLinesItemType =
  (typeof NotificationDataLinesItemType)[keyof typeof NotificationDataLinesItemType];

export const NotificationDataLinesItemType = {
  secondary: 'secondary',
  primary: 'primary',
} as const;
