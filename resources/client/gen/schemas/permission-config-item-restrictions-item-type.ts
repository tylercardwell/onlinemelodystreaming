...
export type PermissionConfigItemRestrictionsItemType =
  (typeof PermissionConfigItemRestrictionsItemType)[keyof typeof PermissionConfigItemRestrictionsItemType];

export const PermissionConfigItemRestrictionsItemType = {
  bool: 'bool',
  number: 'number',
} as const;
