 ...
 */
import type {CrupdateProductBodyPermissionsItemRestrictionsItem} from './crupdate-product-body-permissions-item-restrictions-item';

export type CrupdateProductBodyPermissionsItem = {
  id?: number;
  restrictions?: CrupdateProductBodyPermissionsItemRestrictionsItem[];
};
