 ...
 */
import type {CreateS3MultipartUpload200Acl} from './create-s3-multipart-upload200-acl';

export type CreateS3MultipartUpload200 = {
  key: string;
  uploadId: string;
  acl: CreateS3MultipartUpload200Acl;
};
