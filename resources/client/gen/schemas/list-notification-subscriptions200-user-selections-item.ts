 ...
 */
import type {ListNotificationSubscriptions200UserSelectionsItemChannels} from './list-notification-subscriptions200-user-selections-item-channels';

export type ListNotificationSubscriptions200UserSelectionsItem = {
  id?: number;
  name: string;
  notif_id: string;
  permissions?: string[];
  channels: ListNotificationSubscriptions200UserSelectionsItemChannels;
};
