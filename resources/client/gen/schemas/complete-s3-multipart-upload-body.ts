 ...
 */
import type {CompleteS3MultipartUploadBodyPartsItem} from './complete-s3-multipart-upload-body-parts-item';

export type CompleteS3MultipartUploadBody = {
  key: string;
  uploadId: string;
  /** @minItems 1 */
  parts: CompleteS3MultipartUploadBodyPartsItem[];
  uploadType: string;
  backendId: string;
};
