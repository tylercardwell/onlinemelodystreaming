 ...
 */
import type {NotificationDataLinesItemActionColor} from './notification-data-lines-item-action-color';

export type NotificationDataLinesItemAction = {
  label: string;
  action: string;
  emitOnly?: boolean;
  /** @nullable */
  color?: NotificationDataLinesItemActionColor;
};
