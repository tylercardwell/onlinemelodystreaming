 ...
 */
import type {ListWorkspaceMembers200DataItem} from './list-workspace-members200-data-item';

export type ListWorkspaceMembers200 = {
  data: ListWorkspaceMembers200DataItem[];
};
