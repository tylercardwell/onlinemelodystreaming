 ...
 * @nullable
 */
export type NotificationDataMainActionColor =
  | (typeof NotificationDataMainActionColor)[keyof typeof NotificationDataMainActionColor]
  | null;

export const NotificationDataMainActionColor = {
  primary: 'primary',
  secondary: 'secondary',
  danger: 'danger',
  positive: 'positive',
