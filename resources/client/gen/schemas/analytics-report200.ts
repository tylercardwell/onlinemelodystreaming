 ...
 */
import type {AnalyticsReport200VisitorsReport} from './analytics-report200-visitors-report';

export type AnalyticsReport200 = {
  visitorsReport: AnalyticsReport200VisitorsReport;
  headerReport: string;
};
