 ...
 */
import type {CreateRoleBodyPermissionsItemRestrictionsItem} from './create-role-body-permissions-item-restrictions-item';

export type CreateRoleBodyPermissionsItem = {
  id?: number;
  restrictions?: CreateRoleBodyPermissionsItemRestrictionsItem[];
};
