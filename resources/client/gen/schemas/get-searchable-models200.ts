 ...
 */
import type {GetSearchableModels200ModelsItem} from './get-searchable-models200-models-item';

export type GetSearchableModels200 = {
  models: GetSearchableModels200ModelsItem[];
};
