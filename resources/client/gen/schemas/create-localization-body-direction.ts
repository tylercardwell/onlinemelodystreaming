...
export type CreateLocalizationBodyDirection =
  (typeof CreateLocalizationBodyDirection)[keyof typeof CreateLocalizationBodyDirection];

export const CreateLocalizationBodyDirection = {
  ltr: 'ltr',
  rtl: 'rtl',
} as const;
