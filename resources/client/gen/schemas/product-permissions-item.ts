 ...
 */
import type {ProductPermissionsItemRestrictionsItem} from './product-permissions-item-restrictions-item';

export type ProductPermissionsItem = {
  id: number;
  name: string;
  /** Additional restrictions applied to product for this permission. */
  restrictions: ProductPermissionsItemRestrictionsItem[];
};
