 ...
 */
import type {ValidateUploadBackendCredentialsBodyConfig} from './validate-upload-backend-credentials-body-config';

export type ValidateUploadBackendCredentialsBody = {
  id: string;
  name: string;
  type: string;
  /** @nullable */
  root?: string | null;
  config?: ValidateUploadBackendCredentialsBodyConfig;
};
