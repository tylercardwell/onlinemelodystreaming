...
export type UpdateLocalizationBodyDirection =
  (typeof UpdateLocalizationBodyDirection)[keyof typeof UpdateLocalizationBodyDirection];

export const UpdateLocalizationBodyDirection = {
  ltr: 'ltr',
  rtl: 'rtl',
} as const;
