 ...
 */
import type {NotificationDataButtonActionsItem} from './notification-data-button-actions-item';
import type {NotificationDataLinesItem} from './notification-data-lines-item';
import type {NotificationDataMainAction} from './notification-data-main-action';

export type NotificationData = {
  image: string;
  warning?: boolean;
  mainAction?: NotificationDataMainAction;
  buttonActions?: NotificationDataButtonActionsItem[];
  lines: NotificationDataLinesItem[];
};
