 ...
 */
import type {BatchSignS3PartUrls200UrlsItem} from './batch-sign-s3-part-urls200-urls-item';

export type BatchSignS3PartUrls200 = {
  urls: BatchSignS3PartUrls200UrlsItem[];
};
