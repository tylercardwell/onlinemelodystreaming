...
export type SocialAuthLoginCallback500 =
  | {
      message: "We couldn't find that account. Sign up or try another login method.";
    }
  | {
      message: 'You do not have any supported purchases.';
    }
  | {
      message: 'Could not retrieve social sign in account.';
    };
