 ...
 */
import type {ListNotificationSubscriptions200SubscriptionsItemSubscriptionsItem} from './list-notification-subscriptions200-subscriptions-item-subscriptions-item';

export type ListNotificationSubscriptions200SubscriptionsItem = {
  group_name: string;
  subscriptions: ListNotificationSubscriptions200SubscriptionsItemSubscriptionsItem[];
};
