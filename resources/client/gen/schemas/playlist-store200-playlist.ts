 ...
 */
import type {PlaylistStore200PlaylistEditors} from './playlist-store200-playlist-editors';

export type PlaylistStore200Playlist = {
  id: number;
  name: string;
  public: boolean;
  ...
  editors: PlaylistStore200PlaylistEditors;
  tracks_count: string;
};
