 ...
 */
import type {UpdateNotificationSubscriptionsBodySelectionsItemChannels} from './update-notification-subscriptions-body-selections-item-channels';

export type UpdateNotificationSubscriptionsBodySelectionsItem = {
  notif_id: string;
  channels: UpdateNotificationSubscriptionsBodySelectionsItemChannels;
};
