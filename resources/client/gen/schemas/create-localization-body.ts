 ...
 */
import type {CreateLocalizationBodyDirection} from './create-localization-body-direction';

export type CreateLocalizationBody = {
  name: string;
  /**
   * @minLength 2
   * @maxLength 5
   */
  language?: string;
  direction?: CreateLocalizationBodyDirection;
};
