 ...
 */
import type {InviteWorkspaceMembersBodyEmailsItem} from './invite-workspace-members-body-emails-item';

export type InviteWorkspaceMembersBody = {
  /** @minItems 1 */
  emails: InviteWorkspaceMembersBodyEmailsItem[];
};
