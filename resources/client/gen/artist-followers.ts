...
export const artistFollowersIndex = (
  artist: number,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/artists/${artist}/followers`, method: 'GET'},
    options,
  );
};
export type ArtistFollowersIndexResult = NonNullable<
  Awaited<ReturnType<typeof artistFollowersIndex>>
>;
