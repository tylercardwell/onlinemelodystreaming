...
export const downloadLocalTrackDownload = (
  id: string,
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/tracks/${id}/download`, method: 'GET'},
    options,
  );
};
export type DownloadLocalTrackDownloadResult = NonNullable<
  Awaited<ReturnType<typeof downloadLocalTrackDownload>>
>;
