...
export const youtubeLogStore = (
  options?: SecondParameter<typeof orvalApiFetch<string>>,
) => {
  return orvalApiFetch<string>(
    {url: `/youtube/log-client-error`, method: 'POST'},
    options,
  );
};
export type YoutubeLogStoreResult = NonNullable<
  Awaited<ReturnType<typeof youtubeLogStore>>
>;
