...
export function GenreImage({genre, className, size}: GenreImageProps) {
  ...
  return (
    <span
      className={clsx(
        imgClassName,
        'bg-secondary rounded-card relative isolate flex items-center justify-center overflow-hidden text-xl font-semibold capitalize',
      )}
    >
      {src ? (
        <img
