  ...
  return (
    <div>
      ...
      <MediaPageHeaderLayout
        ...
        subtitle={
          <BulletSeparatedItems className="text-muted-foreground justify-center text-sm md:justify-start">
            <RadioType seed={seed} />
            <Trans
...
function Image({seed}: SeedImageProps) {
  switch (seed.model_type) {
    ...
    case 'genre':
      return (
        <GenreImage genre={seed} size="w-60 h-60" className="mx-auto rounded" />
      );
    default:
      return (
        <TrackImage track={seed} size="w-60 h-60" className="mx-auto rounded" />
      );
  }
}
