...
export interface SettingsPageState {
  ...
  preview: {
    ...
    setThemeRadius: (radius: 'none' | 'sm' | 'md' | 'default') => void;
    setThemeValue: (name: string, value: string) => void;
    setActiveTheme: (theme: CssTheme | null) => void;
    ...
    subscribeWithSelector((set, get) => ({
      ...
      preview: {
        ...
        setThemeRadius: radius => {
          const preview = get().iframeWindow;
          postMessage(preview, {type: 'setThemeRadius', value: radius});
        },
        ...
        setActiveTheme: theme => {
          const preview = get().iframeWindow!;
          postMessage(preview, {type: 'setActiveTheme', theme});
        },
