...
function sizeStyle(size: BreadcrumbsProps['size']): BreadcrumbSizeStyle {
  switch (size) {
    case 'sm':
      return {font: 'text-sm', icon: 'sm', btn: 'icon', minHeight: 'min-h-9'};
    case 'lg':
      return {font: 'text-lg', icon: 'sm', btn: 'icon', minHeight: 'min-h-10.5'};
    case 'xl':
      return {font: 'text-xl', icon: 'sm', btn: 'icon', minHeight: 'min-h-10.5'};
    default:
      return {
        font: 'text-base',
        icon: 'sm',
        btn: 'icon',
        minHeight: 'min-h-10.5',
      };
  }
}
