...
function PlayerLayout({apiRef, rightActions}: PlayerLayoutProps) {
  ...
  return (
    ...
    >
      ...
      <OverlayButtons />
      <BufferingSpinner
        className="spinner pointer-events-none absolute inset-0 z-40 m-auto"
        size="w-12.5 h-12.5"
      />
      <BottomGradient />
      <VideoPlayerControls
...
function OverlayButtons() {
  ...
  return (
    <div
      className={clsx(
        'absolute top-0 left-0 z-40 flex h-full w-full items-center justify-center transition-opacity',
    ...
    >
      ...
      >
        <MediaPlayIcon className="size-6" />
      </Button>
    </div>
  );
}
