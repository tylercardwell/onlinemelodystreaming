...
use Common\Permissions\Policies\PermissionPolicy;
...
use Common\Core\Demo\BlocksDemoSiteMethods;
...
use Common\Core\Policies\CustomPagePolicy;
use Common\Core\Policies\ProductPolicy;
use Common\Core\Policies\ReportPolicy;
use Common\Roles\Policies\RolePolicy;
...
class CommonServiceProvider extends ServiceProvider
{
    ...
    private function setMorphMap(): void
    {
        Relation::enforceMorphMap([
            Workspace::MODEL_TYPE => Workspace::class,
